    ...
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          ...
          <p>Here is a list of handy Wordpress FAQs to help you if you get stuck. Otherwise, please <a href="mailto:libx-ux@virginia.edu">contact the UX Team</a> if you need help.</p>
