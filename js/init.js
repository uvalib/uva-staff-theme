...
(function($){
  $(function(){
    ...
    if ($('.student-personnel-action-form').length) {
    	$('<style media="print">#main article > * {position: static; overflow: visible; margin: 0;} td, th {font-size: 13px; padding: 10px 5px;} th {font-size: 12px; background-color: gray;} #masthead, #mega-menu, div.breadcrumbs, .btn, #comments, #sideNav, footer {display: none;}</style>').appendTo('head');
    }
