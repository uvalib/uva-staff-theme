...
(function($){
  $(function(){
    ...
    if ($('.student-personnel-action-form').length) {
    	$('<style media="print">#main article > * {position: static; overflow: visible; margin: 0;} input, textarea {height: inherit; margin: inherit;} #masthead, #mega-menu, div.breadcrumbs, #comments, #sideNav, footer {display: none;}</style>').appendTo('head');
    }
