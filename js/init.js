...
(function($){
  $(function(){
    ...
    if ($('.student-personnel-action-form').length) {
  	$('<style media="print">#main article > * {overflow: visible; margin: 0;} h1 {font-size: 16px; margin: 0; line-height: 100%} .entry-content {margin: 0; line-height: 1.2;} td, th {font-size: 12px; padding: 3px 3px;} th {background-color: cyan;} #masthead, #mega-menu, div.breadcrumbs, .btn, #comments, #sideNav, footer {display: none; padding: 0; margin: 0;}</style>').appendTo('head');
    }
