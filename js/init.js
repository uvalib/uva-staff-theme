...
(function($){
  $(function(){
    ...
    if ($('.student-personnel-action-form').length) {
    	$('<style media="print">#main article > * {position: static; overflow: visible; margin: 0;} input, textarea {height: 1rem; margin: 0 0 5px;} #masthead, #mega-menu, div.breadcrumbs, #comments, #sideNav, footer {display: none;}</style>').appendTo('head');
    }
