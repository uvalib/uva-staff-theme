  ...
  <nav class="orange darken-3">
    <div class="nav-wrapper">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        <li><a class="dropdown-button" href="<?php bloginfo(''); ?>/our-organization" data-activates="organization-dropdown">Our Organization<i class="material-icons right">arrow_drop_down</i></a></li>
        <li><a class="dropdown-button" href="<?php bloginfo(''); ?>/employee-resources" data-activates="employee-dropdown">Employee Resources<i class="material-icons right">arrow_drop_down</i></a></li>
        <li><a class="dropdown-button" href="<?php bloginfo(''); ?>/data/" data-activates="organization-dropdown">Library Data &amp; Statistics<i class="material-icons right">arrow_drop_down</i></a></li>
        <li><a class="dropdown-button" href="<?php bloginfo(''); ?>/category/forms/" data-activates="organization-dropdown">Forms<i class="material-icons right">arrow_drop_down</i></a></li>
        <li><a class="dropdown-button" href="<?php bloginfo(''); ?>/emergency-preparedness" data-activates="organization-dropdown">Emergency Preparedness<i class="material-icons right">arrow_drop_down</i></a></li>
        <li><a class="dropdown-button" href="<?php bloginfo(''); ?>/about">About</a></li>
      </ul>
    </div>
  </nav>
...
<div id="organization-dropdown" class="dropdown-content container">
      <div class="row">
      <div class="col s4">
...
<div id="employee-dropdown" class="dropdown-content container">
      <div class="row">
      <div class="col s4">
